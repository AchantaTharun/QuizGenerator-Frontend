...
export default function CreateBank() {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      addToast('Bank created successfully!', 'success');
      navigate('/');
    } catch (err) {
      addToast(err.response?.data?.message || 'Failed to create bank', 'error');
    } finally {
    ...
    <div className="mx-auto max-w-lg">
      <div className="mb-8">
        ...
        <p className="text-sm text-body-color">
          Add a new question bank to organize your quiz questions
        </p>
      </div>
